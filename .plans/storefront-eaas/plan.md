...
* [x] [**T01**: Storefront API routes in dashboard app](tasks/T01.md) - Status: ✅ Completed (code-complete; build green; pending live smoke test on deploy)
...
- **2026-04-15**: T01 code-complete — 19 route chunks, buyer session util, CORS middleware, storefront error hook. Dashboard builds clean. Awaiting deploy for live smoke test.
<!-- META_INFORMATION -->
