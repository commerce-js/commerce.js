...
import { h as useForwardProps, j as renderSlotFragments, S as Slot } from './Button-BZcARdSq.mjs';
import { e as unrefElement, j as defaultWindow } from './Input-BDe6KmrB.mjs';
...
function useId(deterministicId, prefix = "reka") {
  var _a, _b;
  if ("useId" in vue) return `${prefix}-${(_b = (_a = vueExports).useId) == null ? void 0 : _b.call(_a)}`;
...
//# sourceMappingURL=Collection-BlAAFbQ5.mjs.map
