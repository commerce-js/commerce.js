import { v as vueExports, a as useAppConfig, s as serverRenderer_cjs_prodExports, d as appConfig, b as useRoute$1 } from './server.mjs';
import { y as defu } from '../nitro/nitro.mjs';
import __nuxt_component_0$1 from './index-DDt1fq8p.mjs';
...
function useForwardProps(props) {
  ...
  const defaultProps = Object.keys((_a2 = vm == null ? void 0 : vm.type.props) != null ? _a2 : {}).reduce((prev, curr) => {
  ...
  return vueExports.computed(() => {
    ...
    const assignedProps = (_a3 = vm == null ? void 0 : vm.vnode.props) != null ? _a3 : {};
...
var cx = (...classnames) => {
  ...
  const buildClassString = (input) => {
    if (!input && input !== 0 && input !== /* @__PURE__ */ BigInt("0")) return;
  ...
  const tv2 = (options, configProp) => {
    ...
    const component = (props) => {
      if (isEmptyObject(variants) && isEmptyObject(slotProps) && isExtendedSlotsEmpty) {
        return cn(base, props == null ? void 0 : props.class, props == null ? void 0 : props.className)(config);
      }
      ...
      const getVariantValue = (variant, vrs = variants, _slotKey = null, slotProps2 = null) => {
        ...
        const variantProp = (_a2 = slotProps2 == null ? void 0 : slotProps2[variant]) != null ? _a2 : props == null ? void 0 : props[variant];
      ...
      const getCompleteProps = (key, slotProps2) => {
        ...
        const initialProp = typeof (props == null ? void 0 : props[key]) === "object" ? {
          [key]: (_a2 = props[key]) == null ? void 0 : _a2.initial
        } : {};
        return {
          ...defaultVariants,
...
var executeMerge = (classnames, config) => {
  ...
  if (!base || !((_a2 = config == null ? void 0 : config.twMerge) != null ? _a2 : true)) return base;
...
function useButtonGroup(props) {
  const buttonGroup = vueExports.inject(buttonGroupInjectionKey, void 0);
  return {
    orientation: vueExports.computed(() => buttonGroup == null ? void 0 : buttonGroup.value.orientation),
    size: vueExports.computed(() => {
      var _a2;
...
function toReactive(objectRef) {
  if (!vueExports.isRef(objectRef))
    return vueExports.reactive(objectRef);
  const proxy = new Proxy({}, {
    get(_, p, receiver) {
      return vueExports.unref(Reflect.get(objectRef.value, p, receiver));
    },
    set(_, p, value) {
      if (vueExports.isRef(objectRef.value[p]) && !vueExports.isRef(value))
  ...
  return vueExports.reactive(proxy);
}
...
function toRef(...args) {
  if (args.length !== 1)
    return vueExports.toRef(...args);
  const r = args[0];
  return typeof r === "function" ? vueExports.readonly(vueExports.customRef(() => ({ get: r, set: noop }))) : vueExports.ref(r);
}
...
function useFormField(props, opts) {
  ...
  return {
    ...
    color: vueExports.computed(() => (formField == null ? void 0 : formField.value.error) ? "error" : props == null ? void 0 : props.color),
    highlight: vueExports.computed(() => (formField == null ? void 0 : formField.value.error) ? true : props == null ? void 0 : props.highlight),
    disabled: vueExports.computed(() => (formOptions == null ? void 0 : formOptions.value.disabled) || (props == null ? void 0 : props.disabled)),
    emitFormBlur,
    emitFormInput,
    emitFormChange,
    emitFormFocus,
...
function _diff(h1, h2) {
  ...
  if (h1.props && h2.props) {
    for (const prop of allProps) {
      ...
      if (p1 && p2) {
        diffs.push(..._diff((_a2 = h1.props) == null ? void 0 : _a2[prop], (_b = h2.props) == null ? void 0 : _b[prop]));
      } else if (p1 || p2) {
        diffs.push(
...
_sfc_main$5.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(Primitive), vueExports.mergeProps({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (show.value) {
              _push2(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.base({ class: (_a3 = props.ui) == null ? void 0 : _a3.base }))}"${_scopeId}>`);
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      serverRenderer_cjs_prodExports.ssrRenderVNode(_push, vueExports.createVNode(vueExports.resolveDynamicComponent(props.chip ? _sfc_main$4 : vueExports.unref(Primitive)), vueExports.mergeProps({ as: __props.as }, props.chip ? typeof props.chip === "object" ? { inset: true, ...props.chip } : { inset: true } : {}, {
        class: ui.value.root({ class: [(_a2 = props.ui) == null ? void 0 : _a2.root, props.class] }),
        style: props.style
      }, _attrs), {
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
                  ...
                  if (_push3) {
                    serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
                      ...
                      if (__props.icon) {
                        ...
                        _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.fallback({ class: (_b2 = props.ui) == null ? void 0 : _b2.fallback }))}"${_scopeId2}>${serverRenderer_cjs_prodExports.ssrInterpolate(fallback.value || "\xA0")}</span>`);
                      }
                    ...
                    return [
                      vueExports.renderSlot(_ctx.$slots, "default", {}, () => {
                        var _a4, _b2;
                        return [
                          __props.icon ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$5, {
                            key: 0,
                            name: __props.icon,
                            class: ui.value.icon({ class: (_a4 = props.ui) == null ? void 0 : _a4.icon })
                          ...
                          }, vueExports.toDisplayString(fallback.value || "\xA0"), 3))
                        ];
                      })
                    ];
                  }
            ...
            return [
              __props.src && !error.value ? (vueExports.openBlock(), vueExports.createBlock(vueExports.resolveDynamicComponent(vueExports.unref(ImageComponent)), vueExports.mergeProps({
                key: 0,
                role: "img",
                src: __props.src,
                alt: __props.alt,
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, vueExports.mergeProps(vueExports.unref(nuxtLinkProps), {
        ...
        default: vueExports.withCtx(({ href, navigate, route: linkRoute, rel, target, isExternal, isActive, isExactActive }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.custom) {
              serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {
                ..._ctx.$attrs,
            ...
            return [
              __props.custom ? vueExports.renderSlot(_ctx.$slots, "default", vueExports.mergeProps({ key: 0 }, {
                ...
                isExternal,
                active: isLinkActive({ route: linkRoute, isActive, isExactActive })
              })) : (vueExports.openBlock(), vueExports.createBlock(_sfc_main$2, vueExports.mergeProps({ key: 1 }, {
                ..._ctx.$attrs,
                ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                as: __props.as,
                type: __props.type,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$1, vueExports.mergeProps({
        ...
        default: vueExports.withCtx(({ active, ...slotProps }, _push2, _parent2, _scopeId) => {
          var _a2, _b;
          if (_push2) {
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$2, vueExports.mergeProps(slotProps, {
              class: ui.value.base({
                ...
                if (_push3) {
                  serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "leading", {}, () => {
                    ...
                    if (vueExports.unref(isLeading) && vueExports.unref(leadingIconName)) {
                      ...
                      _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$3, vueExports.mergeProps({
                  ...
                  serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
                    ...
                    if (__props.label !== void 0 && __props.label !== null) {
                      _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.label({ class: (_a3 = props.ui) == null ? void 0 : _a3.label, active }))}"${_scopeId2}>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.label)}</span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  }, _push3, _parent3, _scopeId2);
                  ...
                  return [
                    ...
                    vueExports.renderSlot(_ctx.$slots, "trailing", {}, () => {
                      var _a3;
                      return [
                        vueExports.unref(isTrailing) && vueExports.unref(trailingIconName) ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$5, {
                          key: 0,
                          name: vueExports.unref(trailingIconName),
                          class: ui.value.trailingIcon({ class: (_a3 = props.ui) == null ? void 0 : _a3.trailingIcon, active })
            ...
            return [
              vueExports.createVNode(_sfc_main$2, vueExports.mergeProps(slotProps, {
                class: ui.value.base({
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { Primitive as P, Slot as S, _sfc_main as _, _sfc_main$5 as a, _sfc_main$3 as b, useButtonGroup as c, useComponentIcons as d, _sfc_main$4 as e, getDisplayValue as f, get as g, useForwardProps as h, isArrayOfArray as i, renderSlotFragments as j, formErrorsInjectionKey as k, inputIdInjectionKey as l, formFieldInjectionKey as m, isDef as n, looseToNumber as o, reactivePick as r, tv as t, useFormField as u };
//# sourceMappingURL=Button-BZcARdSq.mjs.map
