import { _ as _sfc_main$3, r as reactivePick, t as tv, u as useFormField, c as useButtonGroup, d as useComponentIcons, i as isArrayOfArray, a as _sfc_main$5$1, b as _sfc_main$3$1, g as get, e as _sfc_main$4$1, P as Primitive, f as getDisplayValue, h as useForwardProps } from './Button-BZcARdSq.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-zI8G8B_a.mjs';
import { _ as _sfc_main$4 } from './Card-B0Nd1Kdd.mjs';
import { _ as _sfc_main$5 } from './Badge-DNNpgjLr.mjs';
import { v as vueExports, s as serverRenderer_cjs_prodExports, a as useAppConfig } from './server.mjs';
import { u as useForwardPropsEmits, b as useId, P as Presence_default, e as useEmitAsProps, d as useCollection, a as useDirection, c as createContext, g as getActiveElement, i as injectConfigProviderContext } from './Collection-BlAAFbQ5.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$6, b as useVModel$1, u as useForwardExpose, d as useMounted, t as toValue$1, e as unrefElement, r as refAutoReset, f as tryOnBeforeUnmount, o as onKeyStroke, c as useResizeObserver, g as createSharedComposable, h as computedEager, i as createGlobalState } from './Input-BDe6KmrB.mjs';
...
var DismissableLayer_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ownerDocument = vueExports.computed(() => {
      var _a, _b;
      ...
      return vueExports.openBlock(), vueExports.createBlock(DialogContentImpl_default, vueExports.mergeProps({
        ...
        onCloseAutoFocus: _cache[0] || (_cache[0] = (event) => {
          ...
          if (!event.defaultPrevented) {
            event.preventDefault();
            (_a = vueExports.unref(rootContext).triggerElement.value) == null ? void 0 : _a.focus();
          }
        }),
    ...
    return (_ctx, _cache) => {
      return vueExports.openBlock(), vueExports.createBlock(DialogContentImpl_default, vueExports.mergeProps({
        ...
        onCloseAutoFocus: _cache[0] || (_cache[0] = (event) => {
          var _a;
          if (!event.defaultPrevented) {
            if (!hasInteractedOutsideRef.value) (_a = vueExports.unref(rootContext).triggerElement.value) == null ? void 0 : _a.focus();
            event.preventDefault();
          }
        ...
        onInteractOutside: _cache[1] || (_cache[1] = (event) => {
          ...
          const targetIsTrigger = (_a = vueExports.unref(rootContext).triggerElement.value) == null ? void 0 : _a.contains(target);
...
var DialogOverlay_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a;
      return ((_a = vueExports.unref(rootContext)) == null ? void 0 : _a.modal.value) ? (vueExports.openBlock(), vueExports.createBlock(vueExports.unref(Presence_default), {
        key: 0,
...
var PopperContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const reference = vueExports.computed(() => {
      var _a;
    ...
    const cannotCenterArrow = vueExports.computed(() => {
      var _a;
    ...
    return (_ctx, _cache) => {
      ...
      return vueExports.openBlock(), vueExports.createElementBlock("div", {
        ...
        style: vueExports.normalizeStyle({
          ...
          ["--reka-popper-transform-origin"]: [(_a = vueExports.unref(middlewareData).transformOrigin) == null ? void 0 : _a.x, (_b = vueExports.unref(middlewareData).transformOrigin) == null ? void 0 : _b.y].join(" "),
          ...((_c = vueExports.unref(middlewareData).hide) == null ? void 0 : _c.referenceHidden) && {
            visibility: "hidden",
            pointerEvents: "none"
          }
        })
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return vueExports.openBlock(), vueExports.createElementBlock("span", {
        ...
        style: vueExports.normalizeStyle({
          position: "absolute",
          left: ((_a = vueExports.unref(contentContext).arrowX) == null ? void 0 : _a.value) ? `${(_b = vueExports.unref(contentContext).arrowX) == null ? void 0 : _b.value}px` : void 0,
          top: ((_c = vueExports.unref(contentContext).arrowY) == null ? void 0 : _c.value) ? `${(_d = vueExports.unref(contentContext).arrowY) == null ? void 0 : _d.value}px` : void 0,
          [baseSide.value]: 0,
          transformOrigin: {
            top: "",
            right: "0 0",
      ...
      return vueExports.openBlock(), vueExports.createBlock(vueExports.unref(PopperRoot_default), null, {
        default: vueExports.withCtx(() => [vueExports.renderSlot(_ctx.$slots, "default", {
          ...
          default: vueExports.withCtx(() => [vueExports.unref(isNullish)(vueExports.unref(modelValue)) ? (vueExports.openBlock(), vueExports.createElementBlock("option", _hoisted_1$1)) : vueExports.createCommentVNode("v-if", true), (vueExports.openBlock(true), vueExports.createElementBlock(vueExports.Fragment, null, vueExports.renderList(Array.from(optionsSet.value), (option) => {
            var _a2;
            return vueExports.openBlock(), vueExports.createElementBlock("option", vueExports.mergeProps({ key: (_a2 = option.value) != null ? _a2 : "" }, { ref_for: true }, option), null, 16);
          }), 128))]),
          _: 1
        }, 8, [
          "multiple",
      ...
      return vueExports.openBlock(), vueExports.createBlock(vueExports.unref(CollectionSlot), null, {
        default: vueExports.withCtx(() => [vueExports.createVNode(vueExports.unref(FocusScope_default), {
          ...
          onUnmountAutoFocus: _cache[7] || (_cache[7] = (event) => {
            ...
            (_a = vueExports.unref(rootContext).triggerElement.value) == null ? void 0 : _a.focus({ preventScroll: true });
            event.preventDefault();
          })
        }, {
...
var SelectContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      var _a;
      return present.value || renderPresence.value || ((_a = presenceRef.value) == null ? void 0 : _a.present) ? (vueExports.openBlock(), vueExports.createBlock(vueExports.unref(Presence_default), {
        key: 0,
        ref_key: "presenceRef",
        ref: presenceRef,
...
var SelectItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const textValue = vueExports.ref((_a = props.textValue) != null ? _a : "");
...
var SelectTrigger_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const rootContext = injectSelectRootContext();
    const { forwardRef } = useForwardExpose();
    const isDisabled = vueExports.computed(() => {
      var _a;
    ...
    return (_ctx, _cache) => {
      return vueExports.openBlock(), vueExports.createBlock(vueExports.unref(PopperAnchor_default), {
        ...
        default: vueExports.withCtx(() => {
          var _a, _b, _c, _d;
          return [vueExports.createVNode(vueExports.unref(Primitive), {
            ref: vueExports.unref(forwardRef),
            role: "combobox",
            type: _ctx.as === "button" ? "button" : void 0,
            "aria-controls": vueExports.unref(rootContext).contentId,
            "aria-expanded": vueExports.unref(rootContext).open.value || false,
            "aria-required": (_a = vueExports.unref(rootContext).required) == null ? void 0 : _a.value,
            "aria-autocomplete": "none",
            disabled: isDisabled.value,
            dir: (_b = vueExports.unref(rootContext)) == null ? void 0 : _b.dir.value,
            "data-state": ((_c = vueExports.unref(rootContext)) == null ? void 0 : _c.open.value) ? "open" : "closed",
            "data-disabled": isDisabled.value ? "" : void 0,
            "data-placeholder": vueExports.unref(shouldShowPlaceholder)((_d = vueExports.unref(rootContext).modelValue) == null ? void 0 : _d.value) ? "" : void 0,
            "as-child": _ctx.asChild,
            as: _ctx.as,
...
function usePortal(portal) {
  ...
  const value = vueExports.computed(() => portal.value === true ? globalPortal == null ? void 0 : globalPortal.value : portal.value);
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = vueExports.computed(() => {
      var _a;
      return tv({ extend: tv(theme$1), ...((_a = appConfig.ui) == null ? void 0 : _a.modal) || {} })({
                      ...
                      if (_push4) {
                        ...
                        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "content", { close }, () => {
                          ...
                          if (!!slots.header || (__props.title || !!slots.title) || (__props.description || !!slots.description) || (props.close || !!slots.close)) {
                            _push4(`<div class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.header({ class: (_a2 = props.ui) == null ? void 0 : _a2.header }))}"${_scopeId3}>`);
                            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "header", { close }, () => {
                              var _a3, _b3, _c3;
                              _push4(`<div class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.wrapper({ class: (_a3 = props.ui) == null ? void 0 : _a3.wrapper }))}"${_scopeId3}>`);
                              if (__props.title || !!slots.title) {
                          ...
                          if (!!slots.body) {
                            _push4(`<div class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.body({ class: (_b2 = props.ui) == null ? void 0 : _b2.body }))}"${_scopeId3}>`);
                          ...
                          if (!!slots.footer) {
                            _push4(`<div class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.footer({ class: (_c2 = props.ui) == null ? void 0 : _c2.footer }))}"${_scopeId3}>`);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/Modal.vue");
              ...
              default: vueExports.withCtx((_, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  if (vueExports.unref(isLeading) || !!__props.avatar || !!slots.leading) {
                    _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.leading({ class: (_a2 = props.ui) == null ? void 0 : _a2.leading }))}"${_scopeId2}>`);
                  ...
                  serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {
                    ...
                    serverRenderer_cjs_prodExports.ssrRenderList([displayValue(modelValue)], (displayedModelValue) => {
                      ...
                      if (displayedModelValue !== void 0 && displayedModelValue !== null) {
                        _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.value({ class: (_a3 = props.ui) == null ? void 0 : _a3.value }))}"${_scopeId2}>${serverRenderer_cjs_prodExports.ssrInterpolate(displayedModelValue)}</span>`);
                      } else {
                        _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.placeholder({ class: (_b3 = props.ui) == null ? void 0 : _b3.placeholder }))}"${_scopeId2}>${serverRenderer_cjs_prodExports.ssrInterpolate((_c2 = __props.placeholder) != null ? _c2 : "\xA0")}</span>`);
                      }
                      _push3(`<!--]-->`);
                    });
                    _push3(`<!--]-->`);
                  ...
                  if (vueExports.unref(isTrailing) || !!slots.trailing) {
                    _push3(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.trailing({ class: (_b2 = props.ui) == null ? void 0 : _b2.trailing }))}"${_scopeId2}>`);
                    ...
                    vueExports.renderSlot(_ctx.$slots, "default", {
                      ...
                      (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList([displayValue(modelValue)], (displayedModelValue) => {
                        ...
                        return vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, { key: displayedModelValue }, [
                          ...
                          }, vueExports.toDisplayString((_c2 = __props.placeholder) != null ? _c2 : "\xA0"), 3))
                        ], 64);
                      }), 128))
                    ]),
                  ...
                  _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(SelectContent_default), vueExports.mergeProps({
                    ...
                    default: vueExports.withCtx((_2, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(`<div role="presentation" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.viewport({ class: (_a3 = props.ui) == null ? void 0 : _a3.viewport }))}"${_scopeId3}><!--[-->`);
                                      ...
                                      default: vueExports.withCtx((_4, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "item", {
                                            ...
                                            _push6(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemTrailing({ class: [(_c3 = props.ui) == null ? void 0 : _c3.itemTrailing, isSelectItem(item) && ((_d3 = item.ui) == null ? void 0 : _d3.itemTrailing)] }))}"${_scopeId5}>`);
                      ...
                      (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList([displayValue(modelValue)], (displayedModelValue) => {
                        ...
                        return vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, { key: displayedModelValue }, [
                          displayedModelValue !== void 0 && displayedModelValue !== null ? (vueExports.openBlock(), vueExports.createBlock("span", {
                            ...
                            key: 1,
                            class: ui.value.placeholder({ class: (_b3 = props.ui) == null ? void 0 : _b3.placeholder })
                          }, vueExports.toDisplayString((_c = __props.placeholder) != null ? _c : "\xA0"), 3))
                        ], 64);
                      }), 128))
                    ]),
                    vueExports.unref(isTrailing) || !!slots.trailing ? (vueExports.openBlock(), vueExports.createBlock("span", {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_iqdaty4x7fafoooh6yfa6f46wm/node_modules/@nuxt/ui/dist/runtime/components/Select.vue");
...
//# sourceMappingURL=index-_NHXoSdd.mjs.map
