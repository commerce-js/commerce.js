...
import { t as tv, k as formErrorsInjectionKey, l as inputIdInjectionKey, m as formFieldInjectionKey, P as Primitive, u as useFormField, c as useButtonGroup, d as useComponentIcons, a as _sfc_main$5, b as _sfc_main$3, n as isDef$1, o as looseToNumber } from './Button-XkXmlRcK.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const error = vueExports.computed(() => props.error || formErrors?.value?.find((error2) => error2.name && (error2.name === props.name || props.errorPattern && error2.name.match(props.errorPattern)))?.message);
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.label || !!slots.label) {
              _push2(`<div class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.labelWrapper({ class: props.ui?.labelWrapper }))}"${_scopeId}>`);
              ...
              if (__props.hint || !!slots.hint) {
                _push2(`<span${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-hint`)} class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.hint({ class: props.ui?.hint }))}"${_scopeId}>`);
            ...
            if (__props.description || !!slots.description) {
              _push2(`<p${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-description`)} class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.description({ class: props.ui?.description }))}"${_scopeId}>`);
            ...
            if (typeof error.value === "string" && error.value || !!slots.error) {
              _push2(`<div${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-error`)} class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.error({ class: props.ui?.error }))}"${_scopeId}>`);
              ...
              _push2(`<div${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-help`)} class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.help({ class: props.ui?.help }))}"${_scopeId}>`);
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_sjufzgrcbt2v4rspz2tut4zvjy/node_modules/@nuxt/ui/dist/runtime/components/FormField.vue");
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (vueExports.unref(isLeading) || !!__props.avatar || !!slots.leading) {
              _push2(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.leading({ class: props.ui?.leading }))}"${_scopeId}>`);
            ...
            if (vueExports.unref(isTrailing) || !!slots.trailing) {
              _push2(`<span class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.trailing({ class: props.ui?.trailing }))}"${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@3.3.7_@babel+parser@7.29.0_change-case@5.4.4_db0@0.3.4_@electric-sql+pglite@0.3.15_b_sjufzgrcbt2v4rspz2tut4zvjy/node_modules/@nuxt/ui/dist/runtime/components/Input.vue");
...
//# sourceMappingURL=Input-DrLYwZPX.mjs.map
