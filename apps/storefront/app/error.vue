  ...
  <UApp>
    <div class="min-h-screen flex items-center justify-center bg-(--ui-bg)">
      <div class="text-center max-w-md px-6">
        <div class="w-20 h-20 mx-auto mb-6 rounded-2xl bg-(--ui-primary)/10 flex items-center justify-center">
          <UIcon
        ...
        <p class="text-6xl font-bold text-(--ui-text-highlighted) mb-2">
          {{ error.statusCode }}
        </p>

        <h1 class="text-xl font-semibold text-(--ui-text-highlighted) mb-2">
          {{ title }}
        </h1>
