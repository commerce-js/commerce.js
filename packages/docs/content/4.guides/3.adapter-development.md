...
::tip
The `@commercejs/adapter-salla` package serves as the reference implementation for external API adapters. The `@commercejs/platform` package demonstrates a self-contained adapter with a built-in database. Study both when building your own.
::
